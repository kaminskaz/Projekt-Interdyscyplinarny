...
if model_abb == "b0":
    model_names.append("efficientnet_b0_non_pretrained")
elif model_abb == "b7":
    model_names.append("efficientnet_b7_non_pretrained")
elif model_abb == "b0_p":
    model_names.append("efficientnet_b0_pretrained")
elif model_abb == "b7_p":
    model_names.append("efficientnet_b7_pretrained")
